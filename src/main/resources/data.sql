...
insert into manufacturer (id, date_created, name) values (manufacturer_seq.nextval, now(), 'BMW');
insert into manufacturer (id, date_created, name) values (manufacturer_seq.nextval, now(), 'Daimler');

-- Create Cars
insert into car (id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer_id, selected)
values (car_seq.nextval, now(), 'BAE2549', 2, true, 3, 'GAS', 1, false);


insert into car (id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer_id, selected)
values (car_seq.nextval, now(), 'MUN4689', 4, false, 4, 'ELECTRIC', 2, false);
