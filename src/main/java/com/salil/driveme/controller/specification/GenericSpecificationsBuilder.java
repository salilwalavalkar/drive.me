package com.salil.driveme.controller.specification;
...
public class GenericSpecificationsBuilder<U>
{
    ...
    public final GenericSpecificationsBuilder<U> with(
        final String precedenceIndicator, final String key, final String operation, final Object value, final String prefix, final String suffix)
    {
